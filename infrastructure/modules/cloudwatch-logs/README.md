...
| <a name="input_create_log_stream"></a> [create\_log\_stream](#input\_create\_log\_stream) | Whether to create a CloudWatch log stream. Requires create\_log\_group = true. | `bool` | `false` | no |
