...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_iam_policy"></a> [iam\_policy](#module\_iam\_policy) | terraform-aws-modules/iam/aws//modules/iam-policy | 6.6.1 |
...
| <a name="input_path"></a> [path](#input\_path) | The path of the policy | `string` | `"/"` | no |
| <a name="input_policy"></a> [policy](#input\_policy) | Policy document. This is a JSON formatted string. | `string` | `null` | no |
