...
| <a name="output_security_group_id"></a> [security\_group\_id](#output\_security\_group\_id) | First security group ID associated with the cache.<br/>This is security\_group\_ids[0] (caller-managed). |
