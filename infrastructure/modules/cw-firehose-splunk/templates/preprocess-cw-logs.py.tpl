...
def transformLogEvent(log_event, logGroup, logStream):
...
def processRecords(records):
    for r in records:
        ...
        if data['messageType'] == 'CONTROL_MESSAGE':
            ...
            joinedData = ''.join([transformLogEvent(e, data['logGroup'], data['logStream']) for e in data['logEvents']])
