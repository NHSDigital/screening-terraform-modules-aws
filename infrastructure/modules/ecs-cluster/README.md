...
| <a name="input_fargate_ephemeral_storage_kms_key_id"></a> [fargate\_ephemeral\_storage\_kms\_key\_id](#input\_fargate\_ephemeral\_storage\_kms\_key\_id) | Customer managed KMS key ARN for Fargate ephemeral storage encryption. | `string` | `null` | no |
